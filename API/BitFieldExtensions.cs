...
namespace BitField
{
    ...
    public static class BF
    {
        ...
        public static byte ToUInt8(this IBitField obj)
        {
            byte result = 0;
            ...
            foreach (PropertyInfo pi in obj.GetType().GetProperties())
            {
                ...
                if (bitField != null)
                {
                    ...
                    // This conversion makes it possible to use different types in the bit field
                    byte value = Convert.ToByte(pi.GetValue(obj));

                    result |= (byte)((value & mask) << bitField.Offset);
                }
            }
        ...
        public static uint ToUInt32(this IBitField obj)
        {
            uint result = 0;
            ...
            foreach (PropertyInfo pi in obj.GetType().GetProperties())
            {
                ...
                if (bitField != null)
                {
                    ...
                    // This conversion makes it possible to use different types in the bit field
                    uint value = Convert.ToUInt32(pi.GetValue(obj));
